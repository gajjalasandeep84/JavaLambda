...
public class Unit1ExerciseSolutionJava8Lambda {
	...
	public static void main(String[] args) {
		...
		// with C
		System.out.println("Printing all the person beginnning having last name with C");
		printConditionally(people,p->p.getLastName().startsWith("C"));
		System.out.println();
		
		System.out.println("Printing all the person beginnning having first name with C");
